...
<head>
    ...
    <link rel="stylesheet" href="faigas.css">
...
<header>
    ...
    <div class="photoGrapherdescript">
        <h1 class="namePhotographer">Faiga Photography</h1>
        <div class="txtcontainer">
        <p class="description">Welcome to Faiga Photography, where we believe that every moment is worth capturing and cherishing forever. Founded on the passion for photography and the desire to freeze time in stunning imagery, we strive to deliver timeless memories that last a lifetime.</p>
        </div>
    </div>
    <div class="Piccontainer">
        <img src="Faiga/image (2).png" alt="" height="400px">
        <img src="Faiga/image (3).png" alt="" height="400px">
        <img src="Faiga/image (4).png" alt="" height="400px">
    </div>
    <h1 class="pricing">PRICING   &    SERVICE</h1>
    <div class="price1">
            <ul>
                <li>Full day  of on-location shooting </li>
                <li>200+ edited high- resolution  photo </li>
                <li>Online gallery  for viewing  and sharing</li>
                <li>Signature 8x10 canvas Print </li>
            </ul>
