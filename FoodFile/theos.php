...
<head>
    ...
    <title>Theos Cattering</title>
    <link rel="stylesheet" href="Theos.css">
...
<header>
        ...
        <div class="catteringInfo">
            <img src="CatteringLogo/image (4).png" alt="" width="400px">
            <div class="info">
                <p>Theo's Catering Services</p>
                <p>Contact:0916 475 6591</p>
                <p>Email: theoCateringServices@gmail.com</p>
            </div>
        </div>
        <h1 class="pricing">PRICING   &    DISHES</h1>
        <div class="price1">
            <ul>
                <li>Beef with Mushroom and Mashed Spicy Pork Ribs</li>
                <li>Crispy Chicken</li>
                <li>Steamed Fish Fillet in Ginger Sauce Lasagna</li>
                <li>Lechon</li>
                <li>Rice </li>
                <li>Dessert</li>
                <li>Cookies</li>
